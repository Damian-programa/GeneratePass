...
def fizz_buzz(numb):             #Defini la funcion, creando numb como elemento
    for i in range(1,numb+1):    # Utilizo el for para comenzar un contador, poniendo i como variable, y creo el rango
        if i % 3==0 and i % 5==0:#Utilizo if para iniciar la comparacion de i con %(division) y que sea 3 "and"(y) 5=0 ambos ya qjue hacerlo luego solo tomaria la primera opcion que yo escribiera en el codigo
